                            ...
                            <div id="category-view" class="category-grid-layout2 gradient-padding zoom-gallery">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product3.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Electronics</div>
                                                    <ul class="info-link">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product4.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Clothing</div>
                                                    <ul class="info-link">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product5.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Clothing</div>
                                                    <ul class="info-link">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product6.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Clothing</div>
                                                    <ul class="info-link">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product7.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Clothing</div>
                                                    <ul class="info-link">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product8.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Clothing</div>
                                                    <ul class="info-link">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="/img/product/product9.png" alt="categories" class="img-responsive">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    <div class="title-ctg">Clothing</div>
                                                    <ul class="info-link">
                                                        <li><a href="/img/product/product9.png" class="elv-zoom" data-fancybox-group="gallery" title="Title Here"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
                                                        <li><a href="single-product-layout3.html"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                    <div class="symbol-featured"><img src="/img/banner/symbol-featured.png" alt="symbol" class="img-responsive"> </div>
                                                </div>
                                            ...
                                            <div class="item-content">
                                                <div class="title-ctg">Clothing</div>
                                                <h3 class="short-title"><a href="single-product3.html">Stainless Ring</a></h3>
                                                <h3 class="long-title"><a href="single-product3.html">Anti-Rust Stainless Steel Chain Corner Ring</a></h3>
                                                <ul class="upload-info">
                                                    <li class="date"><i class="fa fa-clock-o" aria-hidden="true"></i>07 Mar, 2017</li>
                                                    <li class="place"><i class="fa fa-map-marker" aria-hidden="true"></i>Pune</li>
                                                    <li class="tag-ctg"><i class="fa fa-tag" aria-hidden="true"></i>Clothing</li>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                <div class="add-layout2-left d-flex align-items-center">
                                    <div>
                                        ...
                                        <h3>Post your ad on lane77.com</h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sidebar-item-box">
                            <div class="gradient-wrapper">
                                ...
                                <ul class="sidebar-category-list">
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg1.png" alt="category" class="img-responsive">Electronics<span>(50)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg2.png" alt="category" class="img-responsive">Fashin &amp; Life Style<span>(20)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg3.png" alt="category" class="img-responsive">Car &amp; Vehicles<span>(50)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg4.png" alt="category" class="img-responsive">Hobby, Sport &amp; Kids<span>(20)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg5.png" alt="category" class="img-responsive">Pets &amp; Animals<span>(100)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg6.png" alt="category" class="img-responsive">Overseas Jobs<span>(70)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg7.png" alt="category" class="img-responsive">Property<span>(90)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg8.png" alt="category" class="img-responsive">Education<span>(30)</span></a>
                                    </li>
                                    <li>
                                        <a href="/products"><img src="/img/product/ctg12.png" alt="category" class="img-responsive">Others<span>(150)</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <section class="bg-body s-space full-width-border-top">
            <div class="container">
                <div class="section-title-dark">
                    ...
                    <p>Stay in touch with Lane77 and we'll notify you about best ads</p>
                </div>
